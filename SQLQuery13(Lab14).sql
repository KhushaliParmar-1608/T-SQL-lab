...
SELECT CITY , AVG(SALARY) AS AVG_SALARY , MAX(SALARY) AS MAX_SALARY , MIN(SALARY) AS MIN_SALARY
FROM PERSON P
INNER JOIN DEPARTMENT D
ON P.DEPARTMENTID = D.DEPARTMENTID
GROUP BY CITY
...
--single column) 
SELECT CONCAT(PERSONNAME , '  LIVES IN ' , CITY , '  AND WORKS IN ' , DEPARTMENTNAME)
FROM PERSON P
INNER JOIN DEPARTMENT D
ON P.DEPARTMENTID = D.DEPARTMENTID
...
SELECT DEPARTMENTNAME ,CITY , SUM(SALARY) AS TOTAL_SALARY , AVG(SALARY) AS AVG_SALARY, MAX(SALARY) AS MAX_SALARY
FROM PERSON P
INNER JOIN DEPARTMENT D
ON P.DEPARTMENTID = D.DEPARTMENTID
