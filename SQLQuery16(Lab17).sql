...
SELECT * FROM EMPLOYEE
WHERE SALARY> 14000
SELECT * FROM SALARY_ABOVE_14000

--10. Create a view that displays employees having salary below 10000. 
CREATE VIEW SALARY_BELOW
AS
SELECT * FROM EMPLOYEE
WHERE SALARY<10000
SELECT * FROM SALARY_BELOW
...
CREATE VIEW Firstname_Vowel
AS
SELECT * FROM EMPLOYEE
WHERE FIRSTNAME LIKE '%[AEIOU]%'
SELECT * FROM Firstname_Vowel
...
CREATE VIEW Name_Having_M_N
AS
SELECT * FROM EMPLOYEE
WHERE FIRSTNAME LIKE 'M%N'
SELECT * FROM Name_Having_M_N
