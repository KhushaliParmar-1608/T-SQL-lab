...
SELECT * FROM STUDENT
WHERE BRANCH='CIVIL' OR BRANCH='MICHENICAL' AND SPI < 8.00
...
--CIVIL branch. 
SELECT * FROM STUDENT 
WHERE SPI > 8.0 OR BRANCH = 'COMPUTER' OR BRANCH = 'CIVIL'
...
--7.0. 
SELECT *FROM STUDENT
WHERE BRANCH = 'COMPUTER' AND NOT CITY = 'RAJKOT' AND SPI > 7.0
