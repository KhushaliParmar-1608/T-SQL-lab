...
SELECT * FROM EMPLOYEE
WHERE CITY LIKE '%RA%' AND SALARY < 13000 AND JOININGYEAR LIKE '___[6]'
...
--not in (‘HR’, ‘IT’).
SELECT * FROM EMPLOYEE
WHERE CITY LIKE '%' AND FIRSTNAME NOT LIKE '[AEIOU]%' AND DEPARTMENT NOT IN ('HR', 'IT')
