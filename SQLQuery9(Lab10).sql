...
SELECT SIN(3.1314) , COS(3.1415) , TAN(3.1415)
...
SELECT UPPER('khushali')

--3. Display first three characters of your name. 
SELECT LEFT('KHUSHALI',3)

--4. Display 3rd to 10th character of your name. 
SELECT SUBSTRING('KHUSHALI PARMAR',3,10)
...
SELECT CAST(1234.56 AS VARCHAR(50))
SELECT CONVERT(VARCHAR(50) , 1234.56)
...
SELECT FIRSTNAME , REVERSE(FIRSTNAME) AS REVERCE_NAME
FROM EMPLOYEE
...
SELECT DEPARTMENT , LASTNAME FROM EMPLOYEE
WHERE RIGHT(DEPARTMENT ,1) = RIGHT(LASTNAME, 1)
